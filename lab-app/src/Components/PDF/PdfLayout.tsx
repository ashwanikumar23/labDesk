...
export default function App() {
    return (
        ...
        <Row gutter={24} style={{marginTop:'2px',padding:'1px 0px',alignItems:'center',width:'99%',margin:"0px auto"}}>
          <Col span={15}>
            <Row gutter={24}>
            <Col span={12}><span style={{textTransform:"capitalize"}}>Test Description</span></Col>
            <Col span={12}><span style={{textTransform:'capitalize'}}>Observation Value</span></Col>
            </Row>
          </Col>
          <Col span={9}>
          <Row gutter={24}>
            <Col span={12}><span style={{textTransform:'capitalize'}}>units</span></Col>
            <Col span={12} style={{textAlign:'end',textTransform:'capitalize'}}><span>Reference Value</span></Col>
            </Row>
          </Col>
        </Row>
        </div>

...
export default function SideCard({ id, disabled, InitialData,Success,Error }: ISideCard) {
    ...
    return (
        <>
            <Card title="All Test Here " bordered={false} style={{ width: '100%', height: "100vh" }}>
                <ModalGrid id={ID} disabled={disabled} InitialData={InitialData} Success={Success} Error={Error} />
            </Card>
        </>
    );
}